...
json_loc = r'C:\Users\Kartikeya gupta\OneDrive\Desktop\BTP\Twitter_Sentiment_Analysis-master\twitter_config.json'
...
tweets_df = pd.DataFrame(list(zip(tweet_ls,datetime_ls)),
                  columns=['Tweet','Date'])
...
tweets_df['Tweet_Translated'] = tweets_df['Tweet']
# .apply(lambda text:tcf.translate_tweet(text))
...
# Save the data
tweets_df.to_csv(translated_tweets_filename, encoding='utf-8')
